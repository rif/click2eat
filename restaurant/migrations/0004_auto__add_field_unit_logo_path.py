...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Unit.logo_path'
        db.add_column('restaurant_unit', 'logo_path', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Unit.logo_path'
        db.delete_column('restaurant_unit', 'logo_path')

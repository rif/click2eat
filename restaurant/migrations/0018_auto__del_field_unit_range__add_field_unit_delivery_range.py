...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Unit.delivery_range'
        db.add_column('restaurant_unit', 'delivery_range', self.gf('django.db.models.fields.FloatField')(default=1), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Unit.delivery_range'
        db.delete_column('restaurant_unit', 'delivery_range')

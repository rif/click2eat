...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PartnerPackage.monthly_fee'
        db.add_column('restaurant_partnerpackage', 'monthly_fee', self.gf('django.db.models.fields.FloatField')(default=0.0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PartnerPackage.monthly_fee'
        db.delete_column('restaurant_partnerpackage', 'monthly_fee')

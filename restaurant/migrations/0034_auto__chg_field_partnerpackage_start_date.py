...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PartnerPackage.start_date'
        db.alter_column('restaurant_partnerpackage', 'start_date', self.gf('django.db.models.fields.DateField')())


    def backwards(self, orm):
        
        # Changing field 'PartnerPackage.start_date'
        db.alter_column('restaurant_partnerpackage', 'start_date', self.gf('django.db.models.fields.DateField')(auto_now_add=True))
    ...
    models = {
        ...
        'restaurant.partnerpackage': {
            ...
            'rate': ('django.db.models.fields.FloatField', [], {}),
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 11, 1)'}),

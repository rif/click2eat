...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Unit.open_hours' to match new field type.
        db.rename_column('restaurant_unit', 'open_hours', 'open_hours_id')
        # Changing field 'Unit.open_hours'
        db.alter_column('restaurant_unit', 'open_hours_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['restaurant.Schedule']))

        # Adding index on 'Unit', fields ['open_hours']
        db.create_index('restaurant_unit', ['open_hours_id'])


    def backwards(self, orm):
        
        # Removing index on 'Unit', fields ['open_hours']
        db.delete_index('restaurant_unit', ['open_hours_id'])

        # Renaming column for 'Unit.open_hours' to match new field type.
        db.rename_column('restaurant_unit', 'open_hours_id', 'open_hours')
        # Changing field 'Unit.open_hours'
        db.alter_column('restaurant_unit', 'open_hours', self.gf('django.db.models.fields.CharField')(max_length=10))
    ...
    models = {
        ...
        'restaurant.unit': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'open_hours': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'schedules'", 'to': "orm['restaurant.Schedule']"}),

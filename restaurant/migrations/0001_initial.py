...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'DeliveryArea'
        db.create_table('restaurant_deliveryarea', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('restaurant', ['DeliveryArea'])

        # Adding model 'Communication'
        db.create_table('restaurant_communication', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('restaurant', ['Communication'])

        # Adding model 'PartnerPackage'
        db.create_table('restaurant_partnerpackage', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('details', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('restaurant', ['PartnerPackage'])

        # Adding model 'PaymentMethod'
        db.create_table('restaurant_paymentmethod', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('details', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('restaurant', ['PaymentMethod'])

        # Adding model 'DeliveryType'
        db.create_table('restaurant_deliverytype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('price', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal('restaurant', ['DeliveryType'])
        ...
        # Adding model 'Unit'
        db.create_table('restaurant_unit', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('address', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=75)),
            ('phone', self.gf('django.db.models.fields.CharField')(max_length=15)),
            ('unit_devlivery', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['restaurant.DeliveryArea'])),
            ('overall_discount', self.gf('django.db.models.fields.FloatField')()),
            ('latitude', self.gf('django.db.models.fields.FloatField')()),
            ('longitude', self.gf('django.db.models.fields.FloatField')()),
            ('delivery_time', self.gf('django.db.models.fields.IntegerField')()),
            ('communication', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['restaurant.Communication'])),
            ('package', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['restaurant.PartnerPackage'])),
            ('open_hours', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('minimum_ord_val', self.gf('django.db.models.fields.IntegerField')()),
            ('payment_method', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['restaurant.PaymentMethod'])),
            ('employee', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['restaurant.Employee'])),
            ('contact_person', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('delivery_time_user', self.gf('django.db.models.fields.FloatField')()),
            ('delivery_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['restaurant.DeliveryType'])),
            ('info', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('restaurant', ['Unit'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'DeliveryArea'
        db.delete_table('restaurant_deliveryarea')

        # Deleting model 'Communication'
        db.delete_table('restaurant_communication')

        # Deleting model 'PartnerPackage'
        db.delete_table('restaurant_partnerpackage')

        # Deleting model 'PaymentMethod'
        db.delete_table('restaurant_paymentmethod')

        # Deleting model 'DeliveryType'
        db.delete_table('restaurant_deliverytype')

        # Deleting model 'Employee'
        db.delete_table('restaurant_employee')

        # Deleting model 'Unit'
        db.delete_table('restaurant_unit')

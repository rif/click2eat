...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('restaurant_interval', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('schedule', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['restaurant.Schedule'])),
            ('weekdays', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=13)),
            ('start_hour', self.gf('django.db.models.fields.CharField')(max_length=5)),
            ('end_hour', self.gf('django.db.models.fields.CharField')(max_length=5)),
        ))
        db.send_create_signal('restaurant', ['Interval'])

        # Adding model 'Schedule'
        db.create_table('restaurant_schedule', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('unit', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['restaurant.Unit'])),
        ))
        db.send_create_signal('restaurant', ['Schedule'])


    def backwards(self, orm):
        
        # Deleting model 'Interval'
        db.delete_table('restaurant_interval')

        # Deleting model 'Schedule'
        db.delete_table('restaurant_schedule')

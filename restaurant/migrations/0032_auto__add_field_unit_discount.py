...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Unit.discount'
        db.add_column('restaurant_unit', 'discount', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Unit.discount'
        db.delete_column('restaurant_unit', 'discount')

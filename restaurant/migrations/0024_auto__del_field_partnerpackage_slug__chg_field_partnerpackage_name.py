...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'PartnerPackage.slug'
        db.delete_column('restaurant_partnerpackage', 'slug')

        # Changing field 'PartnerPackage.name'
        db.alter_column('restaurant_partnerpackage', 'name', self.gf('django.db.models.fields.CharField')(max_length=2))


    def backwards(self, orm):
        
        # Adding field 'PartnerPackage.slug'
        db.add_column('restaurant_partnerpackage', 'slug', self.gf('django.db.models.fields.SlugField')(default='test', max_length=50, db_index=True), keep_default=False)

        # Changing field 'PartnerPackage.name'
        db.alter_column('restaurant_partnerpackage', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))
    ...
    models = {
        ...
        'restaurant.partnerpackage': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'default': "'PL'", 'max_length': '2'}),
            'rate': ('django.db.models.fields.FloatField', [], {}),

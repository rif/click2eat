...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Unit.sms_email'
        db.add_column('restaurant_unit', 'sms_email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Unit.sms_email'
        db.delete_column('restaurant_unit', 'sms_email')
    ...
    models = {
        ...
        'restaurant.partnerpackage': {
            ...
            'rate': ('django.db.models.fields.FloatField', [], {}),
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2012, 2, 3)'}),
        ...
        'restaurant.unit': {
            ...
            'sms_email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'null': 'True', 'blank': 'True'})
        },

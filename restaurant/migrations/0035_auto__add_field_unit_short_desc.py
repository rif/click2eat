...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Unit.short_desc'
        db.add_column('restaurant_unit', 'short_desc', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Unit.short_desc'
        db.delete_column('restaurant_unit', 'short_desc')
    ...
    models = {
        ...
        'restaurant.partnerpackage': {
            ...
            'rate': ('django.db.models.fields.FloatField', [], {}),
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 12, 5)'}),

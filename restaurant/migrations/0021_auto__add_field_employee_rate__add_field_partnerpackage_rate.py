...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Employee.rate'
        db.add_column('restaurant_employee', 'rate', self.gf('django.db.models.fields.FloatField')(default=1.0), keep_default=False)

        # Adding field 'PartnerPackage.rate'
        db.add_column('restaurant_partnerpackage', 'rate', self.gf('django.db.models.fields.FloatField')(default=1.0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Employee.rate'
        db.delete_column('restaurant_employee', 'rate')

        # Deleting field 'PartnerPackage.rate'
        db.delete_column('restaurant_partnerpackage', 'rate')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'UnitImage'
        db.create_table('restaurant_unitimage', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('unit', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['restaurant.Unit'])),
            ('image_path', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100)),
        ))
        db.send_create_signal('restaurant', ['UnitImage'])


    def backwards(self, orm):
        
        # Deleting model 'UnitImage'
        db.delete_table('restaurant_unitimage')

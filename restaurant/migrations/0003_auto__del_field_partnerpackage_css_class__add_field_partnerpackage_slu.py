...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'PartnerPackage.css_class'
        db.delete_column('restaurant_partnerpackage', 'css_class')

        # Adding field 'PartnerPackage.slug'
        db.add_column('restaurant_partnerpackage', 'slug', self.gf('django.db.models.fields.SlugField')(default='gold', max_length=50, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'PartnerPackage.css_class'
        db.add_column('restaurant_partnerpackage', 'css_class', self.gf('django.db.models.fields.CharField')(default='gold', max_length=10), keep_default=False)

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Unit.added_date'
        db.add_column('restaurant_unit', 'added_date', self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.date(2010, 10, 12), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Unit.added_date'
        db.delete_column('restaurant_unit', 'added_date')

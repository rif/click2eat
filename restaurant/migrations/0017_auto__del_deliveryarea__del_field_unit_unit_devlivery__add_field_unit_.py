...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Unit.unit_devlivery'
        db.delete_column('restaurant_unit', 'unit_devlivery_id')

        # Adding field 'Unit.range'
        db.add_column('restaurant_unit', 'range', self.gf('django.db.models.fields.FloatField')(default=1), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Unit.unit_devlivery'
        db.add_column('restaurant_unit', 'unit_devlivery', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['restaurant.DeliveryArea']), keep_default=False)

        # Deleting field 'Unit.range'
        db.delete_column('restaurant_unit', 'range')

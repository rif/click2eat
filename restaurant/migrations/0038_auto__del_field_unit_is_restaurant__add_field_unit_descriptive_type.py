...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Unit.is_restaurant'
        db.delete_column('restaurant_unit', 'is_restaurant')

        # Adding field 'Unit.descriptive_type'
        db.add_column('restaurant_unit', 'descriptive_type', self.gf('django.db.models.fields.CharField')(default=u'restaurant', max_length=50), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Unit.is_restaurant'
        db.add_column('restaurant_unit', 'is_restaurant', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Deleting field 'Unit.descriptive_type'
        db.delete_column('restaurant_unit', 'descriptive_type')

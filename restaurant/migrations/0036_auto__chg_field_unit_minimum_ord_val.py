...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Unit.minimum_ord_val'
        db.alter_column('restaurant_unit', 'minimum_ord_val', self.gf('django.db.models.fields.FloatField')())


    def backwards(self, orm):
        
        # Changing field 'Unit.minimum_ord_val'
        db.alter_column('restaurant_unit', 'minimum_ord_val', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        'restaurant.partnerpackage': {
            ...
            'rate': ('django.db.models.fields.FloatField', [], {}),
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.date(2011, 12, 7)'}),

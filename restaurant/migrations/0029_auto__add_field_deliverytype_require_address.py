...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DeliveryType.require_address'
        db.add_column('restaurant_deliverytype', 'require_address', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DeliveryType.require_address'
        db.delete_column('restaurant_deliverytype', 'require_address')

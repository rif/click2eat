...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PartnerPackage.end_date'
        db.alter_column('restaurant_partnerpackage', 'end_date', self.gf('django.db.models.fields.DateField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'PartnerPackage.end_date'
        db.alter_column('restaurant_partnerpackage', 'end_date', self.gf('django.db.models.fields.DateField')(auto_now_add=True, null=True))

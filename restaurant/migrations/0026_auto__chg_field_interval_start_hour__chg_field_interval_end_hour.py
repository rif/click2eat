...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Interval.start_hour'
        db.alter_column('restaurant_interval', 'start_hour', self.gf('django.db.models.fields.CharField')(max_length=8))

        # Changing field 'Interval.end_hour'
        db.alter_column('restaurant_interval', 'end_hour', self.gf('django.db.models.fields.CharField')(max_length=8))


    def backwards(self, orm):
        
        # Changing field 'Interval.start_hour'
        db.alter_column('restaurant_interval', 'start_hour', self.gf('django.db.models.fields.CharField')(max_length=5))

        # Changing field 'Interval.end_hour'
        db.alter_column('restaurant_interval', 'end_hour', self.gf('django.db.models.fields.CharField')(max_length=5))
    ...
    models = {
        ...
        'restaurant.interval': {
            ...
            'end_hour': ('django.db.models.fields.CharField', [], {'max_length': '8'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'schedule': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['restaurant.Schedule']"}),
            'start_hour': ('django.db.models.fields.CharField', [], {'max_length': '8'}),

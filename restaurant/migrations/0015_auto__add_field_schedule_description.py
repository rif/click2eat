...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('restaurant_schedule', 'description', self.gf('django.db.models.fields.CharField')(default='', max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Schedule.description'
        db.delete_column('restaurant_schedule', 'description')
    ...
    models = {
        ...
        'restaurant.unit': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'open_hours': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'sceduled_units'", 'to': "orm['restaurant.Schedule']"}),

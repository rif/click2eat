...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Unit.payment_method'
        db.delete_column('restaurant_unit', 'payment_method_id')

        # Adding field 'Unit.admin_users'
        db.add_column('restaurant_unit', 'admin_users', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding M2M table for field payment_method on 'Unit'
        db.create_table('restaurant_unit_payment_method', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('unit', models.ForeignKey(orm['restaurant.unit'], null=False)),
            ('paymentmethod', models.ForeignKey(orm['restaurant.paymentmethod'], null=False))
        ))
        db.create_unique('restaurant_unit_payment_method', ['unit_id', 'paymentmethod_id'])


    def backwards(self, orm):
        
        # Adding field 'Unit.payment_method'
        db.add_column('restaurant_unit', 'payment_method', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['restaurant.PaymentMethod']), keep_default=False)

        # Deleting field 'Unit.admin_users'
        db.delete_column('restaurant_unit', 'admin_users')

        # Removing M2M table for field payment_method on 'Unit'
        db.delete_table('restaurant_unit_payment_method')

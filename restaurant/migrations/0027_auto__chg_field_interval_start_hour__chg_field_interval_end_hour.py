...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('restaurant_interval', 'start_hour', self.gf('django.db.models.fields.TimeField')())

        # Changing field 'Interval.end_hour'
        db.alter_column('restaurant_interval', 'end_hour', self.gf('django.db.models.fields.TimeField')())

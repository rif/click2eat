...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Rating.feedback'
        db.alter_column('restaurant_rating', 'feedback', self.gf('django.db.models.fields.TextField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Rating.feedback'
        db.alter_column('restaurant_rating', 'feedback', self.gf('django.db.models.fields.TextField')())

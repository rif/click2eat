...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Unit.mobile'
        db.add_column('restaurant_unit', 'mobile', self.gf('django.db.models.fields.CharField')(default='', max_length=15), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Unit.mobile'
        db.delete_column('restaurant_unit', 'mobile')

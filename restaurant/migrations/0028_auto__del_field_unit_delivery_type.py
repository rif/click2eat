...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Unit.delivery_type'
        db.delete_column('restaurant_unit', 'delivery_type_id')

        # Adding M2M table for field delivery_type on 'Unit'
        db.create_table('restaurant_unit_delivery_type', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('unit', models.ForeignKey(orm['restaurant.unit'], null=False)),
            ('deliverytype', models.ForeignKey(orm['restaurant.deliverytype'], null=False))
        ))
        db.create_unique('restaurant_unit_delivery_type', ['unit_id', 'deliverytype_id'])


    def backwards(self, orm):
        
        # Adding field 'Unit.delivery_type'
        db.add_column('restaurant_unit', 'delivery_type', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['restaurant.DeliveryType']), keep_default=False)

        # Removing M2M table for field delivery_type on 'Unit'
        db.delete_table('restaurant_unit_delivery_type')

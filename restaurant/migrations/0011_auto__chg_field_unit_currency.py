...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Unit.currency'
        db.alter_column('restaurant_unit', 'currency_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['restaurant.Currency']))


    def backwards(self, orm):
        
        # Changing field 'Unit.currency'
        db.alter_column('restaurant_unit', 'currency_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['restaurant.PaymentMethod']))

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Unit.currency'
        db.add_column('restaurant_unit', 'currency', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='units_using_this', to=orm['restaurant.PaymentMethod']), keep_default=False)

        # Changing field 'Unit.delivery_time_user'
        db.alter_column('restaurant_unit', 'delivery_time_user', self.gf('django.db.models.fields.FloatField')(null=True))
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Unit.currency'
        db.delete_column('restaurant_unit', 'currency_id')

        # Changing field 'Unit.delivery_time_user'
        db.alter_column('restaurant_unit', 'delivery_time_user', self.gf('django.db.models.fields.FloatField')())
    ...
    models = {
        ...
        'restaurant.unit': {
            ...
            'currency': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'units_using_this'", 'to': "orm['restaurant.PaymentMethod']"}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Unit.package'
        db.delete_column('restaurant_unit', 'package_id')

        # Adding field 'PartnerPackage.unit'
        db.add_column('restaurant_partnerpackage', 'unit', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['restaurant.Unit']), keep_default=False)

        # Adding field 'PartnerPackage.start_date'
        db.add_column('restaurant_partnerpackage', 'start_date', self.gf('django.db.models.fields.DateField')(auto_now_add=True, default=datetime.date(2010, 12, 11), blank=True), keep_default=False)

        # Adding field 'PartnerPackage.end_date'
        db.add_column('restaurant_partnerpackage', 'end_date', self.gf('django.db.models.fields.DateField')(auto_now_add=True, null=True, blank=True), keep_default=False)

        # Adding field 'PartnerPackage.current'
        db.add_column('restaurant_partnerpackage', 'current', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Unit.package'
        db.add_column('restaurant_unit', 'package', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['restaurant.PartnerPackage']), keep_default=False)

        # Deleting field 'PartnerPackage.unit'
        db.delete_column('restaurant_partnerpackage', 'unit_id')

        # Deleting field 'PartnerPackage.start_date'
        db.delete_column('restaurant_partnerpackage', 'start_date')

        # Deleting field 'PartnerPackage.end_date'
        db.delete_column('restaurant_partnerpackage', 'end_date')

        # Deleting field 'PartnerPackage.current'
        db.delete_column('restaurant_partnerpackage', 'current')
    ...
    models = {
        ...
        'restaurant.partnerpackage': {
            ...
            'end_date': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

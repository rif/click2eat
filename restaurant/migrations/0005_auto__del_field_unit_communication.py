...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Unit.communication'
        db.delete_column('restaurant_unit', 'communication_id')

        # Adding M2M table for field communication on 'Unit'
        db.create_table('restaurant_unit_communication', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('unit', models.ForeignKey(orm['restaurant.unit'], null=False)),
            ('communication', models.ForeignKey(orm['restaurant.communication'], null=False))
        ))
        db.create_unique('restaurant_unit_communication', ['unit_id', 'communication_id'])


    def backwards(self, orm):
        
        # Adding field 'Unit.communication'
        db.add_column('restaurant_unit', 'communication', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['restaurant.Communication']), keep_default=False)

        # Removing M2M table for field communication on 'Unit'
        db.delete_table('restaurant_unit_communication')

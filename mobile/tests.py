...
class MobileTest(TestCase):
    ...
    def test_cart_total(self):
        ...
        r = self.client.get(reverse('mobile:shop', args=['rif', '1']))
    ...
    def test_session_motd(self):
        self.client.login(username='rif', password='test')
        r = self.client.get(reverse('mobile:shop', args=['rif', 'm1']))
        self.assertEqual(200, r.status_code)
        self.assertEquals({u'm1': [1, 10.0, u'Meniu complet cu 10 lei']}, self.client.session['1:rif'])

    def test_session_top(self):
        self.client.login(username='rif', password='test')
        self.client.get(reverse('mobile:shop', args=['rif', '1']))
        r = self.client.get(reverse('mobile:shop', args=['rif', '1_1']))
        self.assertEqual(200, r.status_code)
    ...
    def test_session_top_without_item(self):
        self.client.login(username='rif', password='test')
        r = self.client.get(reverse('mobile:shop', args=['rif', '2']))
        r = self.client.get(reverse('mobile:shop', args=['rif', '1_1']))
        self.assertEqual(200, r.status_code)
    ...
    def test_decr_clean_top(self):
        ...
        self.client.login(username='rif', password='test')
        self.client.get(reverse('mobile:shop', args=['rif', '1']))
        self.client.get(reverse('mobile:shop', args=['rif', '1_1']))
        r = self.client.get(reverse('mobile:decr-item', args=['rif', '1', '1']))
        self.assertEqual(200, r.status_code)
    ...
    def test_incr_decr(self):
        ...
        self.client.login(username='rif', password='test')
        self.client.get(reverse('mobile:shop', args=['rif', '1']))
        r = self.client.get(reverse('mobile:incr-item', args=['rif', '1', '1']))

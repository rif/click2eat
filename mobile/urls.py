...
urlpatterns = patterns('',
                       ...
                       url(r'^shop/(?P<item_id>m?\d+)/$', views.shop, name='shop'),
                       url(r'^decritem/(?P<unit_id>\d+)/(?P<item_id>m?\d+)/$', views.decr_item, name='decr-item'),
                       url(r'^incritem/(?P<unit_id>\d+)/(?P<item_id>m?\d+)/$', views.incr_item, name='incr-item'),

...
urlpatterns = patterns('',
                       ...
                       url(r'^shop/(?P<unit_id>\d+)/(?P<item_id>m?\d+-\d+_?\d*)/$', views.shop, name='shop'),
                       url(r'^incr/(?P<unit_id>\d+)/(?P<item_id>m?\d+-\d+_?\d*)/$', views.incr_item, name='incr'),
                       url(r'^decr/(?P<unit_id>\d+)/(?P<item_id>m?\d+-\d+_?\d*)/$', views.decr_item, name='decr'),

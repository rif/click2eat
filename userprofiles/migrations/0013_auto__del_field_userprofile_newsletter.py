...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('userprofiles_userprofile', 'newsletter')


    def backwards(self, orm):
        
        # Adding field 'UserProfile.newsletter'
        db.add_column('userprofiles_userprofile', 'newsletter', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

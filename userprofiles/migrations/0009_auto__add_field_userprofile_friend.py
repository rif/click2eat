...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('userprofiles_userprofile', 'friend', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='friends', null=True, to=orm['auth.User']), keep_default=False)
    ...
    models = {
        ...
        'userprofiles.userprofile': {
            ...
            'friend': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'friends'", 'null': 'True', 'to': "orm['auth.User']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DeliveryAddress.geolocated_address'
        db.alter_column('userprofiles_deliveryaddress', 'geolocated_address', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'DeliveryAddress.geolocated_address'
        raise RuntimeError("Cannot reverse this migration. 'DeliveryAddress.geolocated_address' and its values cannot be restored.")

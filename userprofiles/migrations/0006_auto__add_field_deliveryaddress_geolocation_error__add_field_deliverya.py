...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DeliveryAddress.geolocation_error'
        db.add_column('userprofiles_deliveryaddress', 'geolocation_error', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'DeliveryAddress.verified'
        db.add_column('userprofiles_deliveryaddress', 'verified', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Changing field 'UserProfile.birth_date'
        db.alter_column('userprofiles_userprofile', 'birth_date', self.gf('django.db.models.fields.DateField')(null=True))


    def backwards(self, orm):
        
        # Deleting field 'DeliveryAddress.geolocation_error'
        db.delete_column('userprofiles_deliveryaddress', 'geolocation_error')

        # Deleting field 'DeliveryAddress.verified'
        db.delete_column('userprofiles_deliveryaddress', 'verified')

        # Changing field 'UserProfile.birth_date'
        db.alter_column('userprofiles_userprofile', 'birth_date', self.gf('django.db.models.fields.DateField')())

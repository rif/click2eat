...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('userprofiles_userprofile', 'public', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.public'
        db.delete_column('userprofiles_userprofile', 'public')

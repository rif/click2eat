...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DeliveryAddress.perform_geolocation'
        db.add_column('userprofiles_deliveryaddress', 'perform_geolocation', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DeliveryAddress.perform_geolocation'
        db.delete_column('userprofiles_deliveryaddress', 'perform_geolocation')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field communication on 'UserProfile'
        db.create_table('userprofiles_userprofile_communication', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm['userprofiles.userprofile'], null=False)),
            ('communication', models.ForeignKey(orm['restaurant.communication'], null=False))
        ))
        db.create_unique('userprofiles_userprofile_communication', ['userprofile_id', 'communication_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field communication on 'UserProfile'
        db.delete_table('userprofiles_userprofile_communication')

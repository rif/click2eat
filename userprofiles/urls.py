...
urlpatterns = patterns('',
					   url(r'^createorderaddress/(?P<from_order>\d+)/$', views.create, name='create_address_from_order'),
                       ...
                       url(r'^addrdetail/(?P<object_id>\d+)/$', views.limited_object_detail, {'queryset': DeliveryAddress.objects.all(), "extra_context" : {'back_to_order': cache.get('back_to_order')}}, name='address_detail'),

...
class DeliveryAddressTest(TestCase):
    def setUp(self):
        ...
        self.da1 = DeliveryAddress.objects.create(user=self.user,primary=True,city='1',street='1',number='1',floor=1,ap_number=1)
    ...
    def test_primary_uniquenes(self):
        ...
        DeliveryAddress.objects.create(user=self.user,primary=True,city='1',street='1',number='1',floor=1,ap_number=1)

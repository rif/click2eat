...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('menu_item', 'item_group_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['menu.ItemGroup']))

        # Changing field 'Topping.topping_group'
        db.alter_column('menu_topping', 'topping_group_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['menu.ToppingGroup']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Topping.topping_group'
        db.alter_column('menu_topping', 'topping_group_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['menu.ToppingGroup'], null=True))

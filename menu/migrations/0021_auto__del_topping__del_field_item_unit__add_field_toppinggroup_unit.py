...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('menu_item', 'unit_id')

        # Adding field 'ToppingGroup.unit'
        db.add_column('menu_toppinggroup', 'unit', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['restaurant.Unit']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Item.unit'
        raise RuntimeError("Cannot reverse this migration. 'Item.unit' and its values cannot be restored.")

        # Deleting field 'ToppingGroup.unit'
        db.delete_column('menu_toppinggroup', 'unit_id')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('menu_promotion', (
            ...
            ('weekdays', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=13, null=True, blank=True)),
            ('start_hour', self.gf('django.db.models.fields.CharField')(max_length=5, null=True, blank=True)),
            ('end_hour', self.gf('django.db.models.fields.CharField')(max_length=5, null=True, blank=True)),
            ('value', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('menu', ['Promotion'])

        # Adding field 'Item.promotion'
        db.add_column('menu_item', 'promotion', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['menu.Promotion'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'Promotion'
        db.delete_table('menu_promotion')

        # Deleting field 'Item.promotion'
        db.delete_column('menu_item', 'promotion_id')

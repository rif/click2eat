...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ItemGroup.name_def'
        db.add_column('menu_itemgroup', 'name_def', self.gf('django.db.models.fields.CharField')(default='', max_length=50), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ItemGroup.name_def'
        db.delete_column('menu_itemgroup', 'name_def')

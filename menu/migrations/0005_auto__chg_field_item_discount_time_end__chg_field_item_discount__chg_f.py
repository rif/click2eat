...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Item.discount_time_end'
        db.alter_column('menu_item', 'discount_time_end', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Item.discount'
        db.alter_column('menu_item', 'discount', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Item.item_group'
        db.alter_column('menu_item', 'item_group_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['menu.ItemGroup'], null=True))

        # Changing field 'Item.discount_time_start'
        db.alter_column('menu_item', 'discount_time_start', self.gf('django.db.models.fields.DateTimeField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Item.discount_time_end'
        db.alter_column('menu_item', 'discount_time_end', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Item.discount'
        db.alter_column('menu_item', 'discount', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Item.item_group'
        db.alter_column('menu_item', 'item_group_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['menu.ItemGroup']))

        # Changing field 'Item.discount_time_start'
        db.alter_column('menu_item', 'discount_time_start', self.gf('django.db.models.fields.DateTimeField')())

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('menu_item', 'quantity', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Item.measurement_unit'
        db.add_column('menu_item', 'measurement_unit', self.gf('django.db.models.fields.CharField')(default='GR', max_length=2), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Item.quantity'
        db.delete_column('menu_item', 'quantity')

        # Deleting field 'Item.measurement_unit'
        db.delete_column('menu_item', 'measurement_unit')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Import'
        db.create_table('menu_import', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('import_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('csv_file', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
        ))
        db.send_create_signal('menu', ['Import'])


    def backwards(self, orm):
        
        # Deleting model 'Import'
        db.delete_table('menu_import')

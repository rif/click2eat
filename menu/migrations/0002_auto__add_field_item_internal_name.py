...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Item.internal_name'
        db.add_column('menu_item', 'internal_name', self.gf('django.db.models.fields.CharField')(default='', max_length=50), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Item.internal_name'
        db.delete_column('menu_item', 'internal_name')

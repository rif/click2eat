...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Item.speciality'
        db.add_column('menu_item', 'speciality', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'Item.fortune'
        db.add_column('menu_item', 'fortune', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Item.speciality'
        db.delete_column('menu_item', 'speciality')

        # Deleting field 'Item.fortune'
        db.delete_column('menu_item', 'fortune')
    ...
    models = {
        ...
        'menu.item': {
            ...
            'fortune': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'speciality': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'MenuOfTheDay.name'
        db.add_column('menu_menuoftheday', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=50), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'MenuOfTheDay.name'
        db.delete_column('menu_menuoftheday', 'name')

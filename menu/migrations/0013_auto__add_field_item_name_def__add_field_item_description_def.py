...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Item.name_def'
        db.add_column('menu_item', 'name_def', self.gf('django.db.models.fields.CharField')(default='', max_length=50), keep_default=False)

        # Adding field 'Item.description_def'
        db.add_column('menu_item', 'description_def', self.gf('django.db.models.fields.CharField')(default='', max_length=200), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Item.name_def'
        db.delete_column('menu_item', 'name_def')

        # Deleting field 'Item.description_def'
        db.delete_column('menu_item', 'description_def')

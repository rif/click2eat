...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('menu_language', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('code', self.gf('django.db.models.fields.CharField')(max_length=5)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=16)),
        ))
        db.send_create_signal('menu', ['Language'])

        # Adding model 'VAT'
        db.create_table('menu_vat', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('value', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal('menu', ['VAT'])

        # Adding model 'ItemGroup'
        db.create_table('menu_itemgroup', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('internal_name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('unit', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['restaurant.Unit'])),
            ('exclusive', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('menu', ['ItemGroup'])
        ...
        db.create_table('menu_itemtranslation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('language', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['menu.Language'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('model', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['menu.Item'])),
        ))
        db.send_create_signal('menu', ['ItemTranslation'])

        # Adding model 'Item'
        db.create_table('menu_item', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('unit', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['restaurant.Unit'])),
            ...
            ('discount_time_start', self.gf('django.db.models.fields.DateTimeField')()),
            ('discount_time_end', self.gf('django.db.models.fields.DateTimeField')()),
            ('item_group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['menu.ItemGroup'])),
            ('new_item_end_date', self.gf('django.db.models.fields.DateField')()),
            ('sub_category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['menu.SubCategory'])),
            ('special', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('menu', ['Item'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('menu_language')

        # Deleting model 'VAT'
        db.delete_table('menu_vat')

        # Deleting model 'ItemGroup'
        db.delete_table('menu_itemgroup')

        # Deleting model 'SubCategory'
        db.delete_table('menu_subcategory')

        # Deleting model 'ItemTranslation'
        db.delete_table('menu_itemtranslation')

        # Deleting model 'Item'
        db.delete_table('menu_item')

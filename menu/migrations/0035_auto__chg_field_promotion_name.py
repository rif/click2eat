...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('menu_promotion', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))


    def backwards(self, orm):
        
        # Changing field 'Promotion.name'
        db.alter_column('menu_promotion', 'name', self.gf('django.db.models.fields.CharField')(max_length=50))

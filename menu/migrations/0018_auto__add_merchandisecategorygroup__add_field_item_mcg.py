...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'MerchandiseCategoryGroup'
        db.create_table('menu_merchandisecategorygroup', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('index', self.gf('django.db.models.fields.IntegerField')()),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal('menu', ['MerchandiseCategoryGroup'])

        # Adding field 'Item.mcg'
        db.add_column('menu_item', 'mcg', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['menu.MerchandiseCategoryGroup'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'MerchandiseCategoryGroup'
        db.delete_table('menu_merchandisecategorygroup')

        # Deleting field 'Item.mcg'
        db.delete_column('menu_item', 'mcg_id')

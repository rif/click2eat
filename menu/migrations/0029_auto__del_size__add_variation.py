...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'Size'
        db.delete_table('menu_size')

        # Adding model 'Variation'
        db.create_table('menu_variation', (
        ...
        db.send_create_signal('menu', ['Variation'])


    def backwards(self, orm):
        
        # Adding model 'Size'
        db.create_table('menu_size', (
            ('item', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['menu.Item'])),
            ('price', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('menu', ['Size'])

        # Deleting model 'Variation'
        db.delete_table('menu_variation')

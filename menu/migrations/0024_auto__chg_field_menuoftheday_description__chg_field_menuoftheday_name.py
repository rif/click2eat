...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MenuOfTheDay.description'
        db.alter_column('menu_menuoftheday', 'description', self.gf('django.db.models.fields.TextField')(max_length=50))

        # Changing field 'MenuOfTheDay.name'
        db.alter_column('menu_menuoftheday', 'name', self.gf('django.db.models.fields.CharField')(max_length=30))


    def backwards(self, orm):
        
        # Changing field 'MenuOfTheDay.description'
        db.alter_column('menu_menuoftheday', 'description', self.gf('django.db.models.fields.TextField')())

        # Changing field 'MenuOfTheDay.name'
        db.alter_column('menu_menuoftheday', 'name', self.gf('django.db.models.fields.CharField')(max_length=50))

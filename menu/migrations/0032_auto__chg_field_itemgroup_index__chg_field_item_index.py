...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ItemGroup.index'
        db.alter_column('menu_itemgroup', 'index', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Item.index'
        db.alter_column('menu_item', 'index', self.gf('django.db.models.fields.FloatField')())


    def backwards(self, orm):
        
        # Changing field 'ItemGroup.index'
        db.alter_column('menu_itemgroup', 'index', self.gf('django.db.models.fields.CharField')(max_length=50))

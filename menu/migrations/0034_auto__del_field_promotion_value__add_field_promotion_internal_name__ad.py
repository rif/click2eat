...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Promotion.value'
        db.delete_column('menu_promotion', 'value')

        # Adding field 'Promotion.internal_name'
        db.add_column('menu_promotion', 'internal_name', self.gf('django.db.models.fields.CharField')(default=0, max_length=100), keep_default=False)

        # Adding field 'Promotion.numer_of_items'
        db.add_column('menu_promotion', 'numer_of_items', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)

        # Adding field 'Promotion.total_sum_trigger'
        db.add_column('menu_promotion', 'total_sum_trigger', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)

        # Adding field 'Promotion.procentage'
        db.add_column('menu_promotion', 'procentage', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True), keep_default=False)

        # Adding field 'Promotion.absolute_price'
        db.add_column('menu_promotion', 'absolute_price', self.gf('django.db.models.fields.FloatField')(default=0, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Promotion.value'
        db.add_column('menu_promotion', 'value', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Deleting field 'Promotion.internal_name'
        db.delete_column('menu_promotion', 'internal_name')

        # Deleting field 'Promotion.numer_of_items'
        db.delete_column('menu_promotion', 'numer_of_items')

        # Deleting field 'Promotion.total_sum_trigger'
        db.delete_column('menu_promotion', 'total_sum_trigger')

        # Deleting field 'Promotion.procentage'
        db.delete_column('menu_promotion', 'procentage')

        # Deleting field 'Promotion.absolute_price'
        db.delete_column('menu_promotion', 'absolute_price')
    ...
    models = {
        ...
        'menu.item': {
            ...
            'free_pair': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ToppingTranslation'
        db.create_table('menu_toppingtranslation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('language', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['menu.Language'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('model', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['menu.Topping'])),
        ))
        db.send_create_signal('menu', ['ToppingTranslation'])

        # Adding model 'Topping'
        db.create_table('menu_topping', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('internal_name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('name_def', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('description_def', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('price', self.gf('django.db.models.fields.FloatField')()),
            ('vat', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['menu.VAT'])),
            ('quantity', self.gf('django.db.models.fields.IntegerField')()),
            ('measurement_unit', self.gf('django.db.models.fields.CharField')(default='GR', max_length=2)),
            ('topping_group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['menu.ToppingGroup'], null=True, blank=True)),
            ('added_date', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('mcg', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['menu.MerchandiseCategoryGroup'], null=True, blank=True)),
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'ToppingTranslation'
        db.delete_table('menu_toppingtranslation')
    ...
    models = {
        ...
        'menu.topping': {
            ...
            'price': ('django.db.models.fields.FloatField', [], {}),
            'quantity': ('django.db.models.fields.IntegerField', [], {}),
            'topping_group': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['menu.ToppingGroup']", 'null': 'True', 'blank': 'True'}),
            'vat': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['menu.VAT']"})
        },
        'menu.toppinggroup': {

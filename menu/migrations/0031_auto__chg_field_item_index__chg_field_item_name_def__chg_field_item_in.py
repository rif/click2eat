...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Item.index'
        db.alter_column('menu_item', 'index', self.gf('django.db.models.fields.CharField')(max_length=70))

        # Changing field 'Item.name_def'
        db.alter_column('menu_item', 'name_def', self.gf('django.db.models.fields.CharField')(max_length=70))

        # Changing field 'Item.internal_name'
        db.alter_column('menu_item', 'internal_name', self.gf('django.db.models.fields.CharField')(max_length=70))


    def backwards(self, orm):
        
        # Changing field 'Item.index'
        db.alter_column('menu_item', 'index', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Item.name_def'
        db.alter_column('menu_item', 'name_def', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Item.internal_name'
        db.alter_column('menu_item', 'internal_name', self.gf('django.db.models.fields.CharField')(max_length=50))
    ...
    models = {
        ...
        'menu.item': {
            ...
            'index': ('django.db.models.fields.CharField', [], {'max_length': '70'}),

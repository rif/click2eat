...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BonusTransaction.order'
        db.add_column('bonus_bonustransaction', 'order', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['order.Order'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BonusTransaction.order'
        db.delete_column('bonus_bonustransaction', 'order_id')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('order_orderitem', 'variation', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['menu.Variation'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'OrderItem.variation'
        db.delete_column('order_orderitem', 'variation_id')
    ...
    models = {
        ...
        'order.orderitem': {
            ...
            'variation': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['menu.Variation']", 'null': 'True'})
        },
        'order.rating': {

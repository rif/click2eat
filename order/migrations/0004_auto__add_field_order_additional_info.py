...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Order.additional_info'
        db.add_column('order_order', 'additional_info', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Order.additional_info'
        db.delete_column('order_order', 'additional_info')

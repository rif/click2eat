...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OrderItem.count'
        db.add_column('order_orderitem', 'count', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'OrderItem.count'
        db.delete_column('order_orderitem', 'count')

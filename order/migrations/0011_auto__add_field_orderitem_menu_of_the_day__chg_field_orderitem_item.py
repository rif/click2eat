...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OrderItem.menu_of_the_day'
        db.add_column('order_orderitem', 'menu_of_the_day', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['menu.MenuOfTheDay'], null=True), keep_default=False)

        # Changing field 'OrderItem.item'
        db.alter_column('order_orderitem', 'item_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['menu.Item'], null=True))


    def backwards(self, orm):
        
        # Deleting field 'OrderItem.menu_of_the_day'
        db.delete_column('order_orderitem', 'menu_of_the_day_id')

        # Changing field 'OrderItem.item'
        db.alter_column('order_orderitem', 'item_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['menu.Item']))
    ...
    models = {
        ...
        'menu.menuoftheday': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'items': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['menu.Item']", 'symmetrical': 'False'}),
            'price': ('django.db.models.fields.FloatField', [], {}),
            'unit': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['restaurant.Unit']"})
        },
        'menu.promotion': {

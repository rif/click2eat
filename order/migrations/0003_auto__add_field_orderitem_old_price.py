...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OrderItem.old_price'
        db.add_column('order_orderitem', 'old_price', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'OrderItem.old_price'
        db.delete_column('order_orderitem', 'old_price')

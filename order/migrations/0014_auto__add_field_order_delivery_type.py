...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('order_order', 'delivery_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['restaurant.DeliveryType'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Order.delivery_type'
        db.delete_column('order_order', 'delivery_type_id')

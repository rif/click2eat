...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Order.desired_delivery_time'
        db.add_column('order_order', 'desired_delivery_time', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Order.desired_delivery_time'
        db.delete_column('order_order', 'desired_delivery_time')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OrderItem.topping'
        db.add_column('order_orderitem', 'topping', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['menu.Topping'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'OrderItem.topping'
        db.delete_column('order_orderitem', 'topping_id')

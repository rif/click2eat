...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Order.paid_with_bonus'
        db.add_column('order_order', 'paid_with_bonus', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Order.paid_with_bonus'
        db.delete_column('order_order', 'paid_with_bonus')
    ...
    models = {
        ...
        'order.orderitem': {
            ...
            'topping': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['menu.Topping']", 'null': 'True'})
        },
        'order.rating': {

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Rating.delivery_time'
        db.alter_column('order_rating', 'delivery_time', self.gf('django.db.models.fields.CharField')(max_length=2))

        # Changing field 'Rating.quality'
        db.alter_column('order_rating', 'quality', self.gf('django.db.models.fields.CharField')(max_length=1))


    def backwards(self, orm):
        
        # Changing field 'Rating.delivery_time'
        db.alter_column('order_rating', 'delivery_time', self.gf('django.db.models.fields.SmallIntegerField')())

        # Changing field 'Rating.quality'
        db.alter_column('order_rating', 'quality', self.gf('django.db.models.fields.SmallIntegerField')())

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OrderItem.master'
        db.add_column('order_orderitem', 'master', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['order.OrderItem'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'OrderItem.master'
        db.delete_column('order_orderitem', 'master_id')

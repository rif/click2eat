...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Order.employee'
        db.add_column('order_order', 'employee', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['restaurant.Employee']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Order.employee'
        db.delete_column('order_order', 'employee_id')

...
urlpatterns = patterns('',
       ...
       url(r'^shop/(?P<cart_name>.+)/(?P<item_id>\d+_m?\d+_?\d*-?\d*)/$', views.shop, name='shop'),
       url(r'^decritem/(?P<cart_name>.+)/(?P<unit_id>\d+)/(?P<item_id>m?\d+_m?\d+_?\d*-?\d*)/$', views.decr_item,
           name='decr-item'),
       url(r'^incritem/(?P<cart_name>.+)/(?P<unit_id>\d+)/(?P<item_id>m?\d+_m?\d+_?\d*-?\d*)/$', views.incr_item,
           name='incr-item'),

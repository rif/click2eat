...
urlpatterns = patterns('',
                       ...
                       url(r'^decritem/(?P<cart_name>.+)/(?P<unit_id>\d+)/(?P<item_id>m?\d+_\d+_?\d*)/$', views.decr_item,
                           name='decr-item'),
                       url(r'^incritem/(?P<cart_name>.+)/(?P<unit_id>\d+)/(?P<item_id>m?\d+_\d+_?\d*)/$', views.incr_item,
                           name='incr-item'),
